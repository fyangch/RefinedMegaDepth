...
def concat_matches(
    ...
    """Concatenate matches from two h5 files into one h5 file.

    Args:
        matches1_path (Path): Path to first h5 file.
        matches2_path (Path): Path to second h5 file.
        ensemble_features_path (Path): Path to concatenated features.
        out_path (Path): Path to output h5 file.
    """
    ensemble_matches: Dict[str, Any] = {}
